...
function removeSkeletons() {
  document.querySelectorAll('.skeleton').forEach(($dom) => {
    $dom.classList.remove('skeleton');
  });
  document.querySelectorAll('.skeleton-article').forEach(($dom) => {
    $dom.parentNode.removeChild($dom);
  });
  document.querySelectorAll('.skeleton-topic').forEach(($dom) => {
    $dom.parentNode.removeChild($dom);
  });
  document.querySelectorAll('.skeleton-tag').forEach(($dom) => {
    $dom.parentNode.removeChild($dom);
  });
}
